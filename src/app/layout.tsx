...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" suppressHydrationWarning>
      <body className={`${inter.variable} font-sans antialiased text-white selection:bg-fuchsia-500/30`} suppressHydrationWarning style={{ fontFamily: "Inter, system-ui, sans-serif", backgroundColor: "var(--bg-base)" }}>
        {/* Global Ambient Background */}
        <div className="fixed inset-0 overflow-hidden pointer-events-none z-[-1]">
          <div className="absolute top-[-20%] left-[-10%] w-[60vw] h-[60vw] rounded-full blur-[140px] mix-blend-screen bg-violet-900/10" />
          <div className="absolute bottom-[-20%] right-[-10%] w-[60vw] h-[60vw] rounded-full blur-[140px] mix-blend-screen bg-cyan-900/10" />
          <div className="absolute top-[30%] left-[40%] w-[40vw] h-[40vw] rounded-full blur-[120px] mix-blend-screen bg-emerald-900/5" />
